...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('forum_forumuser')


        # Changing field 'Question.slug'
        db.alter_column('forum_question', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=50, populate_from='title', unique_with=()))
        # Adding unique constraint on 'Question', fields ['slug']
        db.create_unique('forum_question', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Question', fields ['slug']
        db.delete_unique('forum_question', ['slug'])

        # Adding model 'ForumUser'
        db.create_table('forum_forumuser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal('forum', ['ForumUser'])


        # Changing field 'Question.slug'
        db.alter_column('forum_question', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
