...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Point.amount'
        db.delete_column('forum_point', 'amount')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Point.amount'
        raise RuntimeError("Cannot reverse this migration. 'Point.amount' and its values cannot be restored.")
